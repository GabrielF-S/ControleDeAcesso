    	...
    	<div align="center">
    		<fieldset class="saida">
                ...
                <?php
					...
					$str = "SELECT cadastros.RG, cadastros.nome,  cadastros.empresa,  visitas.motivo,  visitas.entradaDia, visitas.entradaHora, visitas.saidaDia, visitas.saidaHora FROM cadastros, visitas WHERE cadastros.RG=visitas.Cadastros_RG AND visitas.saidaDia IS NOT NULL ORDER BY visitas.saidaDia DESC LIMIT 1 ";
				...
				echo "<table cellpadding='3'>";
					...
					echo "<tr><td align='left'>RG: </td><td align='left'> Nome: </td><td align='left'> Empresa: </td><td align='left'>Motivo: </td><td align='left'>Entrada: </td><td align='left'>Saida: </td>";
          					echo "<tr><td>". $linha[0] . " |</td><td>" . $linha[1] . " |</td><td>" . $linha[2] . " |</td><td>" . $linha[3] . " |</td><td>" . $linha[4] . " - " . $linha[5] . " |</td><td> ". $linha[6]  . " - " . $linha[7] . " |</td></tr></table>";
