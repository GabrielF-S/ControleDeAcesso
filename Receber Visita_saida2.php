    	...
    	<div align="center">
    		<fieldset class="saida">
                ...
                <?php
					...
					$str = "SELECT cadastros.RG, cadastros.nome,  cadastros.empresa,  visitas.motivo,  visitas.entradaDia, visitas.entradaHora, visitas.idVisita FROM cadastros, visitas WHERE cadastros.RG=visitas.Cadastros_RG ORDER BY idVisita DESC LIMIT 1 ";
				...
				echo "<table>";
					...
					echo '<img src="data:image/jpeg;base64,'.base64_encode( $result['Foto'] ).'" width="250px" height="250px" alt="Imagem não localizada"/>';
          					...
          					echo " <p><tr><td>ID: " . $linha[6] . "</td><td> RG: ". $linha[0] . "</td><td> Nome: " . $linha[1] . "</td><td> Empresa: " . $linha[2] . " </td><td> Motivo: " . $linha[3] . "</td><td> Entrada: " . $linha[4] . " - " . $linha[5] .  "</td></tr></p></table>";
                ...
                <br><br>
                 ...
                 <form action="Inserir_dados_saida2.php" method="post" name="visita">
                	<table>
						<tr>
